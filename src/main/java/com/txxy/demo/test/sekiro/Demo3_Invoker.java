package com.txxy.demo.test.sekiro;
...
class Demo3_Invoker {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        SekiroInvoker sekiroInvoker = new SekiroInvoker(new SekiroInvoker.Builder().apiToken("7cd51507-cb3a-4a8a-aba2-4c6d66906e9d").apiEntry("http://127.0.0.1:5612"));
